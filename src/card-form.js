...
export default class CardForm extends React.Component {
  ...
  render() {
    ...
    return (
      <form className="col-10 offset-1 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-4 offset-lg-4 mt-2 border rounded card-body shadow form-bg" onSubmit={this.handleSubmit}>
